...
// PDF.js renders in a Web Worker compiled to a blob URL and decodes fonts from
// wasm, so the CSP must allow worker-src blob:, wasm-unsafe-eval, and inline
// styles used by the app shell. Kept strict everywhere else so uploaded document
// content cannot exfiltrate or be framed.
