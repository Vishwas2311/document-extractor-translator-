...
class FinancialReview(Base):
    """Append-only reviewer decision bound to an exact financial result hash."""
    ...
    structure_decisions: Mapped[list[dict[str, object]]] = mapped_column(
        JSON, default=list
    )
    ...
    document = relationship("Document", back_populates="financial_reviews")
